...
export default function ProductsDashboard() {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-white/80 backdrop-blur-md rounded-3xl p-8 shadow-2xl border border-amber-200">
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/admin/products/import"
              className="inline-flex items-center gap-3 px-8 py-4 bg-white border-2 border-[#E37836] text-[#B55424] font-semibold rounded-xl hover:bg-[#E37836] hover:text-white transition-all shadow-lg hover:shadow-xl hover:scale-105 transform duration-200"
            >
              <Upload className="h-5 w-5" />
      ...
      {/* Grid de Estado y Próximos Pasos */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white/80 backdrop-blur-md rounded-3xl shadow-2xl border border-amber-200">
          ...
          <div className="p-6 space-y-4">
            ...
            <div className="flex items-center justify-between p-4 rounded-2xl bg-gradient-to-r from-emerald-50 to-emerald-100 border border-emerald-200">
              <div className="flex items-center gap-3">
                <div className="w-4 h-4 bg-emerald-500 rounded-full shadow-sm"></div>
                <span className="font-medium text-gray-900">Autenticación</span>
              </div>
              <span className="text-sm font-semibold text-emerald-600 bg-emerald-100 px-3 py-1 rounded-full">
                Activa
              </span>
            ...
            <div className="flex items-center justify-between p-4 rounded-2xl bg-gradient-to-r from-amber-50 to-orange-100 border border-amber-200">
              ...
              <span className="text-sm font-semibold text-amber-600 bg-amber-100 px-3 py-1 rounded-full">
                {stats.expiringProducts} productos
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white/80 backdrop-blur-md rounded-3xl shadow-2xl border border-amber-200">
          ...
          <div className="p-6 space-y-4">
            <div className="flex items-center p-4 rounded-2xl border-2 border-blue-200 hover:bg-blue-50 transition-all duration-200 hover:shadow-md cursor-pointer">
            ...
            <div className="flex items-center p-4 rounded-2xl border-2 border-purple-200 hover:bg-purple-50 transition-all duration-200 hover:shadow-md cursor-pointer">
              ...
              <div>
                ...
                <div className="text-gray-600">
                  Crea códigos QR para tus productos
                </div>
              </div>
            </div>

            <div className="flex items-center p-4 rounded-2xl border-2 border-emerald-200 hover:bg-emerald-50 transition-all duration-200 hover:shadow-md cursor-pointer">
              ...
              <div>
                ...
                <div className="text-gray-600">
                  Prueba el sistema escaneando QRs
                </div>
              </div>
            </div>
          </div>
